...
BEGIN
    ...
    WITH current_user_id AS (
        -- FIX 1: Rename 'id' to 'cur_uid' to avoid ambiguity with return column "id"
    ...
    member_communities AS (
        -- FIX 2: Rename 'community_id' to 'joined_comm_id' to avoid ambiguity with return column "community_id"
    ...
    feed_items AS (
        ...
        WHERE p.is_deleted = false
          AND (
                -- Use the new unique alias 'joined_comm_id' here
