                ...
                <form onSubmit={handleSubmit} className="p-4 md:p-8">
                    ...
                    <div className="flex gap-2 mb-8">
                        {[1, 2, 3, 4].map((s) => (
                            <div
                                key={s}
                                className={`h-1.5 flex-1 rounded-full transition-all ${s <= step ? 'bg-brand-green' : 'bg-tertiary-light dark:bg-tertiary'
                                    }`}
                            />
                        ))}
                    </div>
                    ...
                    {/* Navigation */}
                    <footer className="flex justify-between items-center pt-6 md:pt-8 mt-6 md:mt-8 border-t border-tertiary-light dark:border-tertiary">
                        <button
                            type="button"
                            onClick={() => setStep(Math.max(1, step - 1))}
                            className={`py-2 px-4 md:px-6 rounded-full transition-all text-sm md:text-base ${step === 1
                        ...
                        <div className="flex gap-2 md:gap-3">
                            {step < 4 ? (
                                <button
                                    ...
                                    className="py-2 px-6 md:px-8 rounded-full text-black bg-brand-green hover:bg-brand-green-darker disabled:opacity-50 disabled:cursor-not-allowed transition-all text-sm md:text-base"
                                >
                                    Continue
                                </button>
                            ) : (
                                <>
                                    <button
                                        ...
                                        className="py-2 px-4 md:px-6 rounded-full hover:bg-tertiary-light/60 dark:hover:bg-tertiary transition-all text-sm md:text-base"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="py-2 px-6 md:px-8 rounded-full text-black bg-brand-green hover:bg-brand-green-darker disabled:opacity-50 transition-all text-sm md:text-base"
                                    >
