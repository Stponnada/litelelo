    ...
    return (
        ...
        >
            ...
            <div className="md:hidden h-full w-full flex items-center justify-between px-4 relative z-20">
                        ...
                        <div ref={menuRef} className="relative">
                            <div className={`absolute top-full mt-3 w-64 bg-secondary-light dark:bg-secondary rounded-xl shadow-2xl border border-tertiary-light dark:border-tertiary transition-all duration-300 ease-in-out origin-top-left left-0 ${isMenuOpen ? 'opacity-100 scale-100' : 'opacity-0 scale-95 pointer-events-none'}`}>
                                <div className="p-2">
                                    ...
                                    <div className="my-1 h-px bg-tertiary-light dark:bg-tertiary/50" />
                                    <Link href="/terms" onClick={() => setMenuOpen(false)} className="flex items-center gap-3 w-full text-left px-3 py-2 rounded-md text-sm font-medium text-text-secondary-light dark:text-text-secondary hover:bg-tertiary-light dark:hover:bg-tertiary"><ShieldCheckIcon className="w-5 h-5" /> Terms of Service</Link>
                                    <Link href="/privacy" onClick={() => setMenuOpen(false)} className="flex items-center gap-3 w-full text-left px-3 py-2 rounded-md text-sm font-medium text-text-secondary-light dark:text-text-secondary hover:bg-tertiary-light dark:hover:bg-tertiary"><LockClosedIcon className="w-5 h-5" /> Privacy Policy</Link>
                                    <div className="my-1 h-px bg-tertiary-light dark:bg-tertiary/50" />
                ...
                <div className="">
                    <Link href="/" className="text-4xl font-raleway font-black text-brand-green tracking-tighter">
                        litelelo.
                    </Link>
                </div>
            ...
            <div className="hidden md:flex h-full w-full items-center justify-between px-8 relative z-20">
                ...
                <div className={`transition-all duration-300 ${isSidebarExpanded ? 'w-64' : 'w-20'} flex items-center`}>
                    <Link href="/" className="flex items-center gap-3 text-brand-green relative z-10">
