...
const VisibilityIcon = ({ visibility }: { visibility: 'public' | 'friends' | 'specific' }) => {
    switch (visibility) {
        case 'public': return <GlobeAmericasIcon className="w-3 h-3 text-text-tertiary-light dark:text-text-tertiary" />;
        case 'friends': return <UserGroupIcon className="w-3 h-3 text-text-tertiary-light dark:text-text-tertiary" />;
        case 'specific': return <LockClosedIcon className="w-3 h-3 text-text-tertiary-light dark:text-text-tertiary" />;
        default: return null;
    }
};
            ...
            >
                ...
                {post.reposted_by && (
                    <div className="bg-tertiary-light/30 dark:bg-white/5 px-3.5 py-1.5 text-[11px] font-semibold text-text-tertiary-light dark:text-text-tertiary flex items-center gap-2 border-b border-transparent dark:border-white/5">
                        ...
                        <Link href={`/profile/${post.reposted_by.username}`} className="hover:text-brand-green transition-colors" onClick={e => e.stopPropagation()}>
                                            ...
                                            <div className="relative overflow-hidden rounded-xl bg-black/5 dark:bg-black/20 border border-tertiary-light dark:border-white/10 transition-all hover:border-brand-green/50 dark:hover:border-brand-green/50">
                                                ...
                                                <div className="p-4">
                                                    <div className="flex items-center gap-2 mb-2">
                                                        <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-brand-green/10 text-brand-green uppercase tracking-wider">
                                                            BLOG
                                                        </span>
