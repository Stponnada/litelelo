        ...
        <div className="relative w-full max-w-xl mx-auto" ref={searchRef}>
            <div className="relative" style={{ zIndex: 50 }}>
                <input
                    ...
                    className={`w-full pl-10 pr-10 py-3 bg-secondary-light dark:bg-secondary border-2 rounded-full text-base transition-all shadow-lg hover:shadow-xl focus:outline-none ${isFocused
