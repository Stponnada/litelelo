...
const ItemCard: React.FC<{ item: ItemType; onItemReclaimed: (itemId: string) => void; }> = ({ item, onItemReclaimed }) => {
    ...
    const handleContact = () => {
        if (!poster) return;
        router.push(`/chat?recipient=${poster.user_id}`);
    };
        ...
        <div className="group bg-gradient-to-br from-secondary-light to-secondary-light dark:from-secondary dark:to-secondary rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl border border-tertiary-light dark:border-tertiary flex flex-col transition-all duration-300 hover:-translate-y-1 hover:border-orange-500 hover:shadow-orange-500/20 relative">
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="absolute top-3 right-3">
                    <span className={`px-3 py-1 md:px-4 md:py-1.5 rounded-xl text-xs font-bold shadow-lg border backdrop-blur-sm ${isFound
            ...
            <div className="relative z-10 p-4 md:p-5 flex-grow flex flex-col">
                ...
                <div className="flex items-start gap-2 mb-3 px-2.5 py-2 md:px-3 md:py-2 bg-tertiary-light/50 dark:bg-tertiary/50 rounded-lg border border-tertiary-light dark:border-tertiary">
                    ...
                    <div>
                        <p className="text-[10px] md:text-xs font-bold text-text-secondary-light dark:text-text-secondary uppercase tracking-wide">
                            {locationLabel}
                        </p>
                        <p className="text-xs md:text-sm font-semibold text-text-main-light dark:text-text-main">
                            {item.location_found}
                        </p>
                    </div>
                </div>

                <p className="text-xs md:text-sm text-text-secondary-light dark:text-text-secondary mb-4 flex-grow line-clamp-3 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-secondary-light to-tertiary-light/30 dark:from-secondary dark:to-tertiary/30 rounded-2xl shadow-2xl w-full max-w-2xl border border-tertiary-light dark:border-tertiary animate-slideUp" onClick={e => e.stopPropagation()}>
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <header className="flex items-center justify-between pb-5 border-b border-tertiary-light dark:border-tertiary">
                        <div className="flex items-center gap-3">
                            <div className={`p-2 md:p-3 rounded-xl flex items-center justify-center shadow-md ${isFound
                    ...
                    <footer className="flex justify-end gap-3 pt-6 mt-6 border-t border-tertiary-light dark:border-tertiary">
                        <button
                            type="button"
                            onClick={onClose}
                            className="py-2.5 px-5 md:py-3 md:px-6 rounded-xl font-semibold text-text-main-light dark:text-text-main hover:bg-tertiary-light dark:hover:bg-tertiary transition-all"
                        >
                            Cancel
                        </button>
                        <button
                            ...
                            className="py-2.5 px-6 md:py-3 md:px-8 rounded-xl font-bold text-white bg-gradient-to-r from-orange-500 to-red-600 hover:shadow-lg hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-2"
                        >
                            {isSubmitting ? (
                                <>
                                    <Spinner />
