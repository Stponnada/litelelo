                ...
                <div className="p-4 sm:p-8 pb-4 sm:pb-6">
                    <div className="flex items-start gap-3 sm:gap-6 mb-4 sm:mb-5">
                        ...
                        <div className="flex-1 min-w-0 pt-0 sm:pt-1">
                            <Link to={`/communities/${community.id}`} className="block group/link mb-2 sm:mb-3">
                                <h3 className="text-lg sm:text-2xl font-bold text-text-main-light dark:text-text-main group-hover/link:text-brand-green transition-colors leading-tight">
                                    {community.name}
                                </h3>
                            </Link>
                    ...
                    {/* Description */}
                    <p className="text-xs sm:text-sm text-text-secondary-light dark:text-text-secondary line-clamp-2 leading-relaxed mb-4 sm:mb-6">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        <Link 
                            ...
                            className="flex-1 text-center py-2.5 sm:py-3 px-3 sm:px-4 text-xs sm:text-sm font-bold bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 text-text-main-light dark:text-text-main rounded-xl transition-all border border-black/5 dark:border-white/5 hover:border-black/10 dark:hover:border-white/10 group/view"
                        >
                            <span className="inline-flex items-center gap-1.5 sm:gap-2">
                                View
                                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 group-hover/view:translate-x-0.5 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <button 
                            ...
                            className={`flex-1 py-2.5 sm:py-3 px-3 sm:px-4 text-xs sm:text-sm font-bold rounded-xl transition-all border ${
                                community.is_member 
